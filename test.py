...
def test(params, data_params, paths, exp_folder=None):
    """Test the model and generate visualizations"""
    if exp_folder is None:
        # Use the current directory if no experiment folder is provided
        exp_folder = '.'
...
if __name__ == '__main__':
    ...
    test(params,data_params, paths, os.path.join(exp_folder, exp_name))